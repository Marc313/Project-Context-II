...
{
    public static async void ItemPickupAnimation(GameObject _gameObject, float _scaleMultiplier, float _seconds, Action onDone = null)
    {
    ...
    private static async Task ScaleImageInSeconds(GameObject _gameObject, float _scaleMultiplier, float _seconds)
    {
